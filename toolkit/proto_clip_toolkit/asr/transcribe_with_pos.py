...
def transcribe_with_verb_and_noun_matching(asr_config_path, tagger):
    ...
    recorder_stopper = recorder.listen_in_background(source, record_callback, phrase_time_limit=record_timeout)
        ...
        try:
            ...
            if not data_queue.empty():
                ...
                if parsed_action and parsed_noun:
                    ...
                    recorder_stopper(wait_for_stop=True)
                    return parsed_action, parsed_noun
                
                if not parsed_action or not parsed_noun:
                    print("Please speak a word present in the dictionary.")
